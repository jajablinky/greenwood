  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[variant=line]/tabs-list:text-foreground/50 group-data-[variant=line]/tabs-list:data-active:text-foreground",
        className
      )}
      {...props}
    />
